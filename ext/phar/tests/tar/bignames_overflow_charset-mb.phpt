...
$tar->init();
$tar->addFile('АБВГДЕЖЗИЙКЛМНОПF'.str_repeat('a', 101), 'hi');
$tar->addFile('АБВГДЕЖЗИЙКЛМНОПF'.str_repeat('a', 255), 'hi2');
$tar->close();
...
--EXPECT--
АБВГДЕЖЗИЙКЛМНОПFa
АБВГДЕЖЗИЙКЛМНОПFaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
hi
hi2
===DONE===
