...
--CLEAN--
<?php
@unlink(dirname(__FILE__) . '/tar_001АБВГДЕЖЗИЙКЛМНОПF.phar.tar');
?>
--EXPECTF--
Warning: fopen(phar://%star_001.phar.tar/tar_001-mbАБВГДЕЖЗИЙКЛМНОПF.phpt): failed to open stream: phar error: "%star_001АБВГДЕЖЗИЙКЛМНОПF.phar.tar" is a corrupted tar file (truncated) in %star_001-mbАБВГДЕЖЗИЙКЛМНОПF.php on line 9
