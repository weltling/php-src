 ...
 */
PHPAPI char *php_replace_controlchars_ex(char *str, php_size_t len)
{
...
/* {{{ php_url_decode
 */
PHPAPI php_size_t php_url_decode(char *str, php_size_t len)
{
	char *dest = str;
	char *data = str;
...
/* {{{ php_raw_url_decode
 */
PHPAPI php_size_t php_raw_url_decode(char *str, php_size_t len)
{
	char *dest = str;
	char *data = str;
