...
inline static void
php_sprintf_appendchar(char **buffer, php_size_t *pos, php_size_t *size, char add TSRMLS_DC)
{
	if ((*pos + 1) >= *size) {
		*size <<= 1;
...
inline static void
php_sprintf_appendstring(char **buffer, php_size_t *pos, php_size_t *size, char *add,
...
inline static void
php_sprintf_appendint(char **buffer, php_size_t *pos, php_size_t *size, php_int_t number,
...
inline static void
php_sprintf_appenduint(char **buffer, php_size_t *pos, php_size_t *size,
					   php_uint_t number,
					   php_size_t width, char padding, php_size_t alignment)
{
	char numbuf[NUM_BUF_SIZE];
...
inline static void
php_sprintf_appenddouble(char **buffer, php_size_t *pos,
						 php_size_t *size, double number,
...
inline static void
php_sprintf_append2n(char **buffer, php_size_t *pos, php_size_t *size, php_int_t number,
 ...
 */
static char *
php_formatted_print(int ht, php_size_t *len, int use_array, int format_offset TSRMLS_DC)
{
	zval ***args, **z_format;
	int argc;
