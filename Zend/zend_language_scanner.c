...
#line 1090 "Zend/zend_language_scanner.c"
{
	YYCTYPE yych;
...
#line 1440 "Zend/zend_language_scanner.c"
yy31:
		YYDEBUG(31, *YYCURSOR);
		yych = *++YYCURSOR;
		if (yych == '>') goto yy35;
...
#line 1948 "Zend/zend_language_scanner.c"
yy81:
		YYDEBUG(81, *YYCURSOR);
		yych = *++YYCURSOR;
		if (yych <= '_') {
	...
	if (yyleng < MAX_LENGTH_OF_LONG - 1) { /* Won't overflow */
		...
		if (errno == ERANGE) { /* Overflow */
			...
			if (yytext[0] == '0') { /* octal overflow */
				ZVAL_BIGINT(zendlval, big = zend_bigint_init_strtol(yytext, &end, 8));
			} else {
				ZVAL_BIGINT(zendlval, big = zend_bigint_init_strtol(yytext, &end, 10));
			}
		...
		/* Also not an assert for the same reason */
		} else if (end != yytext + yyleng) {
			zend_error_noreturn(E_COMPILE_ERROR, "Invalid numeric literal");
		}
	}
	return T_LNUMBER;
}
#line 2736 "Zend/zend_language_scanner.c"
yy137:
...
#line 1587 "Zend/zend_language_scanner.l"
	...
	if (len < SIZEOF_ZEND_LONG * 8) {
		...
		zend_bigint *big;
		ZVAL_BIGINT(zendlval, big = zend_bigint_init_from_string_length(bin, len, 2));
...
#line 1648 "Zend/zend_language_scanner.l"
	...
	if (len < SIZEOF_ZEND_LONG * 2 || (len == SIZEOF_ZEND_LONG * 2 && *hex <= '7')) {
		...
		ZVAL_BIGINT(zendlval, zend_bigint_init_from_string_length(hex, len, 16));
	}
	return T_LNUMBER;
}
