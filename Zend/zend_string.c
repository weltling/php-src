...
ZEND_API const char *(*zend_new_interned_string)(const char *str, zend_size_t len, int free_src TSRMLS_DC);
ZEND_API void (*zend_interned_strings_snapshot)(TSRMLS_D);
ZEND_API void (*zend_interned_strings_restore)(TSRMLS_D);

static const char *zend_new_interned_string_int(const char *str, zend_size_t len, int free_src TSRMLS_DC);
...
static const char *zend_new_interned_string_int(const char *arKey, zend_size_t nKeyLength, int free_src TSRMLS_DC)
{
#ifndef ZTS
	zend_uint_t h;
	uint nIndex;
