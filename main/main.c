 ...
 */
static int php_get_display_errors_mode(char *value, php_size_t value_length)
{
	int mode;
...
/* {{{ php_html_puts */
PHPAPI void php_html_puts(const char *str, php_size_t size TSRMLS_DC)
{
...
static void php_error_cb(int type, const char *error_filename, const php_size_t error_lineno, const char *format, va_list args)
{
	char *buffer;
...
static char *php_resolve_path_for_zend(const char *filename, php_size_t filename_len TSRMLS_DC) /* {{{ */
{
 ...
 */
static int php_get_configuration_directive_for_zend(const char *name, php_size_t name_length, zval *contents)
{
 ...
 */
static void php_message_handler_for_zend(php_int_t message, const void *data TSRMLS_DC)
{
	switch (message) {
